...
<body>
  ...
  <h1 class="mt-5" align="center">Registro de Empleados</h1> 
  <div class="page-section">
  <div class="container">
  <h2>Empleados activos registrados</h2>   
  <br> 
  <?php 
                ...
                $stringQuerry = "SELECT IdEmpleado,Nombre_empleado, Puesto from empleado";
...

                {
                        ...
                        echo "<tr>";
                            ...
                            <td class="center aligned">
                                <a href="vActualizarE.php?GetID=<?php echo $IdEmpleado ?>">
                                <button  class="btn btn-warning">Editar</button>
                                </a>
                            </td>
                            <td class="center aligned">
                                <a href="deleteEmpl.php?Del=<?php echo $IdEmpleado ?>">
...
<h1 class="mt-5" align="center">Registra un nuevo Empleado</h1> 
  <div class="page-section">
  <div class="form">

    <form method="post" action="insertarempleado.php" class="contact-form mt-1"  >
        <div class="row mb-3">
      ...
      <br>          
      <div class="d-flex justify-content-center">
      <input type="submit" class="next btn btn-info" value="Enviar" />
      </div>
...
<footer class="page-footer">
  ...
  <script src='http://cdnjs.cloudflare.com/ajax/libs/jquery/2.1.3/jquery.min.js'></script>
      ...
      <script>
       function foo(){
              var w = window.open('reporteEmpleados.php', 'Reporte'); w.print;
              }
      </script>
