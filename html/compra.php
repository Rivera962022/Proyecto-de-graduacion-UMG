...
<form method="post" action="" class="contact-form mt-1"  >
    <div class="row mb-3">
        ...
        <div class="col-sm-6 py-2 wow fadeInRight">
              <label for="Mecanico">Soliciutd</label>
              <select id="IdEmpleado" name="IdEmpleado" class="form-control">
              </select>
        </div>

        <div class="col-sm-6 py-2 wow fadeInRight">
              <label for="Mecanico">Proveedor</label>
              <select id="IdEmpleado" name="IdEmpleado" class="form-control">
              </select>
        </div>

        <div class="col-sm-6 py-2 wow fadeInRight">
             <label for="Orden">No. Factura</label>
             <input type="text" name="Orden" id="Orden"  class="form-control" placeholder="Factura..." required>
        </div>
        <div class="col-sm-6 py-2 wow fadeInRight">
             <label for="Orden">Serie</label>
             <input type="text" name="Orden" id="Orden"  class="form-control" placeholder="Serie..." required>
        </div>
        <div class="col-sm-6 py-2 wow fadeInRight">
             <label for="NIT">No. Placa</label>
             <input type="text" name="NIT" id="NIT"  class="form-control" placeholder="No. placa..." required>
        </div>
        <div class="col-sm-6 py-2 wow fadeInRight">
        ...
        <div class="col-sm-6 py-2 wow fadeInRight">
             <label for="NIT">Total Compra</label>
             <input type="text" name="NIT" id="NIT"  class="form-control" placeholder="Total compra..." required>
        </div>
        <div class="col-sm-6 py-2 wow fadeInRight">
             <label for="NIT">No. Orden</label>
             <input type="text" name="NIT" id="NIT"  class="form-control" placeholder="No.orden..." required>
        </div>
        <div class="col-sm-6 py-2 wow fadeInRight">
